...
#ifndef VERILATED_VTEST_PARALLEL_TRNG_H_
#define VERILATED_VTEST_PARALLEL_TRNG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_parallel_trng final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_parallel_trng(Vtest_parallel__Syms* symsp, const char* v__name);
    ~Vtest_parallel_trng();
    VL_UNCOPYABLE(Vtest_parallel_trng);
