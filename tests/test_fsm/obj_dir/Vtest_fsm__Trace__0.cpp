...
void Vtest_fsm___024root__trace_chg_0_sub_0(Vtest_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgBit(oldp+3,((((2U == (IData)(vlSelfRef.test_fsm__DOT__fsm_inst__DOT__state)) 
        ...
        bufp->chgCData(oldp+5,(vlSelfRef.test_fsm__DOT__fsm_inst__DOT__NS),3);
        bufp->chgCData(oldp+6,(vlSelfRef.test_fsm__DOT__fsm_inst__DOT__counter),6);
        bufp->chgCData(oldp+7,(vlSelfRef.test_fsm__DOT__fsm_inst__DOT__run_cycle_counter),3);
    }
    bufp->chgBit(oldp+8,(vlSelfRef.test_fsm__DOT__clk));
    bufp->chgBit(oldp+9,(vlSelfRef.test_fsm__DOT__rst));
}
