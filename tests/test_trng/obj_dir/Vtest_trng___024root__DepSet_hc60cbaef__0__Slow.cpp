...
VL_ATTR_COLD void Vtest_trng___024root___eval_static__TOP(Vtest_trng___024root* vlSelf);
...
VL_ATTR_COLD void Vtest_trng___024root___eval_static(Vtest_trng___024root* vlSelf) {
    ...
    // Body
    Vtest_trng___024root___eval_static__TOP(vlSelf);
}

VL_ATTR_COLD void Vtest_trng___024root___eval_static__TOP(Vtest_trng___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_trng___024root___eval_static__TOP\n"); );
    Vtest_trng__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.test_trng__DOT__trng_inst__DOT__n3__DOT__sumL 
        = ((IData)(vlSelfRef.test_trng__DOT__trng_inst__DOT__s) 
           ^ (1U & (0x41fdc9dU >> (IData)(vlSelfRef.test_trng__DOT__trng_inst__DOT__n3__DOT__C5))));
    vlSelfRef.test_trng__DOT__trng_inst__DOT__n3__DOT__sumR 
...
VL_ATTR_COLD void Vtest_trng___024root___ctor_var_reset(Vtest_trng___024root* vlSelf) {
    ...
    vlSelf->test_trng__DOT__trng_inst__DOT__f0__DOT__state = VL_RAND_RESET_I(3);
    vlSelf->test_trng__DOT__trng_inst__DOT__f0__DOT__cnt = VL_RAND_RESET_I(6);
    vlSelf->test_trng__DOT__trng_inst__DOT__n1__DOT__a = VL_RAND_RESET_I(17);
    vlSelf->test_trng__DOT__trng_inst__DOT__n1__DOT__mux1_in = VL_RAND_RESET_I(1);
    vlSelf->test_trng__DOT__trng_inst__DOT__n2__DOT__b = VL_RAND_RESET_I(16);
    vlSelf->test_trng__DOT__trng_inst__DOT__n2__DOT__mux1_in = VL_RAND_RESET_I(1);
    vlSelf->test_trng__DOT__trng_inst__DOT__n3__DOT__C5 = VL_RAND_RESET_I(5);
    vlSelf->test_trng__DOT__trng_inst__DOT__n3__DOT__C4 = VL_RAND_RESET_I(5);
    vlSelf->test_trng__DOT__trng_inst__DOT__n3__DOT__C3 = VL_RAND_RESET_I(5);
    vlSelf->test_trng__DOT__trng_inst__DOT__n3__DOT__C2 = VL_RAND_RESET_I(5);
    vlSelf->test_trng__DOT__trng_inst__DOT__n3__DOT__C1 = VL_RAND_RESET_I(5);
    vlSelf->test_trng__DOT__trng_inst__DOT__n3__DOT__C0 = VL_RAND_RESET_I(5);
    vlSelf->test_trng__DOT__trng_inst__DOT__n3__DOT__sumL = VL_RAND_RESET_I(5);
    vlSelf->test_trng__DOT__trng_inst__DOT__n3__DOT__sumR = VL_RAND_RESET_I(5);
    vlSelf->test_trng__DOT__trng_inst__DOT__n3__DOT__gamma_mult_inst__DOT____VdfgRegularize_hb2e29eae_0_4 = VL_RAND_RESET_I(1);
